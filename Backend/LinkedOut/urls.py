...
from credentials.views import CandidateConfigViewSet, CandidateViewSet, EducationViewSet, EmployerConfigViewSet, EmployerViewSet, ExperienceViewSet, UserViewSet, GroupViewSet
